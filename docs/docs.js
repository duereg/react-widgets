/*! v"2.1.0" | (c) 2014 Jason Quense | https://github.com/jaquense/react-widgets/blob/master/License.txt */
	        ...
	        return !dates.inRange(day, this.props.min, this.props.max)
	            ...
	            : (React.createElement("td", {key: 'day_' + idx}, 
	                React.createElement(Btn, {
	                  ...
	                  React.createElement("div", null, 
	                    React.createElement("div", {className: "rw-btn--day"}, 
	                      dates.format(day, 'dd')
	                    ), 
	                    React.createElement("div", {className: "rw-btn--content"}, 
	                      "CONTENT GOES HERE"
	                    )
	                  )
	                )
